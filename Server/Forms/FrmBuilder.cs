...
using Settings = xServer.Core.Data.Settings;
...
namespace xServer.Forms
{
    public partial class FrmBuilder : Form
    {
        ...
        private BuildOptions ValidateInput()
        {
            ...
            {
                MessageBox.Show("Could not locate \"client.bin\" file. It should be in the same directory as SeroXen.",
            ...
            using (SaveFileDialog sfd = new SaveFileDialog())
            {
                ...
                name = sfd.FileName;
                path = sfd.FileName;
                File.WriteAllText("input.txt", sfd.FileName);
                ProcessStartInfo psi = new ProcessStartInfo("Phantom.exe");
